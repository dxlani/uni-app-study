        ...
        <form @submit="formSubmit" @reset="formReset">
          <view class="section section_gap">
            ...
            <view class="icon-input">
              <input
                name="numberPlate"
                placeholder="请输入车牌号"
                v-model="formData.carLicenseNumber"
                @change="chargePhone($event,'code')"
              />
              <img src="/static/images/ocamera.png" name="star" class="icon" @click="chooseimage()" />
            </view>
          </view>
          <view class="section section_gap">
            <view class="section__title">
          ...
          <view class="section section_gap">
            ...
            <input
              ...
              @click="seletPhone"
              :disabled="isHavePhone"
            />
          </view>
          <view class="section section_gap">
            <view class="section__title">姓名</view>
            <input name="name" placeholder="请输入司机姓名" v-model="formData.driverName" />
          </view>
          <view class="section section_gap">
            <view class="section__title">
              起始地
            ...
            <!-- <input
              ...
              @click="showPop()"
            />-->
            <picker mode="region" @change="RegionChange" class="picker">
              <view>{{region[0]}}{{region[1]}}{{region[2]}}</view>
            </picker>
          </view>
          <view class="section section_gap">
            <view class="section__title"></view>
            <input name="startAddressDetail" placeholder="请输入详细地址" v-model="formData.originDetails" />
          </view>
          <view class="section section_gap">
            <view class="section__title">
              目的地
          ...
          <view class="section section_gap">
            ...
            <input
              name="licensePlateColor"
              placeholder="请输入详细地址"
              v-model="formData.destinationDetails"
            />
          </view>
          <view class="btn-area">
            <button form-type="submit" :disabled="isFinish">创建</button>
          </view>
        </form>
      </div>
...
import api_order from "../../http/api/api_order";
