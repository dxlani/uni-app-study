...
<uni-shadow-root class="vant-stepper-index"><view class="van-stepper custom-class">
  <view :class="'minus-class van-stepper__minus '+(minusDisabled ? 'van-stepper__minus--disabled' : '')" hover-class="van-stepper__minus--hover" hover-stay-time="70" @click="onMinus"></view>
  <view :class="'input-class van-stepper__input-wrapper '+(disabled || disableInput ? 'van-stepper__input-wrapper--disabled' : '')" @click="onClickWrapper">
    <input :type="integer ? 'number' : 'digit'" class="van-stepper__input" :value="value" :focus="focus" :disabled="disabled || disableInput" @input="onInput" @focus="onFocus" @blur="onBlur"></input>
  </view>
  <view :class="'plus-class van-stepper__plus '+(plusDisabled ? 'van-stepper__plus--disabled' : '')" hover-class="van-stepper__plus--hover" hover-stay-time="70" @click="onPlus"></view>
