<template>
<uni-shadow-root class="vant-search-index"><view :class="'van-search custom-class '+(showAction || useActionSlot ? 'van-search--show-action' : '')" :style="'background: '+(background)">
