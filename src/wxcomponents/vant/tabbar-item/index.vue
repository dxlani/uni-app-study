<template>
<uni-shadow-root class="vant-tabbar-item-index"><view :class="'van-tabbar-item custom-class '+(active ? 'van-tabbar-item--active' : '')" :style="active && color ? 'color: ' + color : ''" @click="onClick">
