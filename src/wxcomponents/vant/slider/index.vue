<template>
<uni-shadow-root class="vant-slider-index"><view :class="'custom-class van-slider '+(disabled ? 'van-slider--disabled' : '')" :style="inactiveColor ? 'background:' + inactiveColor : ''" @click="onClick">
